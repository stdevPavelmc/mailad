...
- Added: Added a new target: "backup" it will make a backup of the actual state and tag it as working.
- Added: Added a new target, please use it wisely: "purge-backups".
